...
all_fd_groups <- list(
  malesWTjuv = result_common$fd_list$malesWTjuv,
  malesHRMjuv = result_common$fd_list$malesHRMjuv,
  femalesWTjuv = result_common$fd_list$femalesWTjuv,
  femalesHRMjuv = result_common$fd_list$femalesHRMjuv,
  
  malesWTado = result_common$fd_list$malesWTado,
  malesHRMado = result_common$fd_list$malesHRMado,
  femalesWTado = result_common$fd_list$femalesWTado,
  femalesHRMado = result_common$fd_list$femalesHRMado,
  
  malesWTadu = result_common$fd_list$malesWTadu,
  malesHRMadu = result_common$fd_list$malesHRMadu,
  femalesWTadu = result_common$fd_list$femalesWTadu
)
