...
subgroups <- list(
  Females_WT   = grep("^Females WT", groups_names),
  Males_WT = grep("^Males WT", groups_names),
  Females_HRM      = grep("^Females HRM", groups_names),
  Males_HRM     = grep("^Males HRM ", groups_names)
)
