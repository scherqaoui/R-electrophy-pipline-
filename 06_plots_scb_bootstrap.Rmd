...
specific_comp <- list(
  ...
  #Age
  c("Males HRM Age", "Males WT Age"),
  c("Females HRM Age", "Females WT Age"),
  ...
  c("Males HRM Juvenile",   "Males HRM Age"),
  c("Males HRM Adolescent", "Males HRM Adult"),
  c("Males HRM Adolescent", "Males HRM Age"),
  c("Males HRM Adult",      "Males HRM Age"),

  # Males - WT
  c("Males WT Juvenile",    "Males WT Adolescent"),
  c("Males WT Juvenile",    "Males WT Adult"),
  c("Males WT Juvenile",    "Males WT Age"),
  c("Males WT Adolescent",  "Males WT Adult"),
  c("Males WT Adolescent",  "Males WT Age"),
  c("Males WT Adult",       "Males WT Age"),
  

  # Females - HRM
  c("Females HRM Juvenile",    "Females HRM Adolescent"),
  c("Females HRM Juvenile",    "Females HRM Adult"),
  c("Females HRM Juvenile",    "Females HRM Age"),
  c("Females HRM Adolescent",  "Females HRM Adult"),
  c("Females HRM Adolescent",  "Females HRM Age"),
  c("Females HRM Adult",       "Females HRM Age"),

  # Females - WT
  c("Females WT Juvenile",     "Females WT Adolescent"),
  c("Females WT Juvenile",     "Females WT Adult"),
  c("Females WT Juvenile",     "Females WT Age"),
  c("Females WT Adolescent",   "Females WT Adult"),
  c("Females WT Adolescent",   "Females WT Age"),
  c("Females WT Adult",        "Females WT Age")
)
