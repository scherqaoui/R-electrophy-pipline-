...
# Capture printed text into a variable
summary_text <- capture.output({
  ...
  for (comparison in names(scb_results)) {
    ...
    cat("  Bonferroni corrected:       ", round(pvals_Bonferroni[comparison], 4), "\n")
...
# Save as PNG
png("SCB_summary_stat/SCB_summary_statistics.png", width = 1600, height = 1200, res = 150)
grid.newpage()
grid.text(paste(summary_text, collapse = "\n"),
          x = 0.02, y = 1, just = c("left", "top"),
          gp = gpar(fontsize = 12))
dev.off()
