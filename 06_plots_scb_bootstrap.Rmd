...
specific_comp <- list(
  ...
  #--------- Sexes comparaisons: (Age, genotype)fixed ---------
  
  #Juvenile
  c("Males WT Juvenile", "Females WT Juvenile"),
  c("Males HRM Juvenile", "Females HRM Juvenile"),
  
  #Adolescent
  c("Males WT Adolescent", "Females WT Adolescent"),
  c("Males HRM Adolescent", "Females HRM Adolescent"),
  
  #Adult
  c("Males WT Adult", "Females WT Adult"),
  c("Males HRM Adult", "Females HRM Adult"),
  
  #Age
  c("Males WT Aged", "Females WT Aged"),
  c("Males HRM Aged", "Females HRM Aged")
...
plot_scb <- function(Time, scb, title) {
  ...
  abline(v = c(360, 1740), col = c("black","black"), lty = 3)
