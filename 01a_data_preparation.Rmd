...
data_win <- read_excel("C:/Users/bs/Desktop/R-electrophy-pipline-/all data.xlsx", sheet = "Ado WIN&cont V2")
...
cleaned_data_win <- clean_data(data_win, 10, 2400, c(1:4,9,10,16,24,31,32,42,50,57), method = "linear")
...
matrix_win <- as.matrix(cleaned_data_win[, -1])
...
all_groups <- list(
  ...
  #win
  WT_males_Ado  = matrix_win[,1:8], NAIVE_males_Ado_C57 = matrix_win[, 9:15],
  VEHICLE_males_Ado_C57 = matrix_win[, 16:21] , WIN = matrix_win[, 22:30], 
  SR_WIN = matrix_win[,31:37] , HRM_males_Ado_paper_WIN = matrix_win[, 38:45]
...
groups_names <- c(
  ...
  "WT_males_Ado", "NAIVE_males_Ado_C57", "VEHICLE_males_Ado_C57", "WIN", "SR_WIN", "HRM_males_Ado_paper_WIN"
  )
...
lty <- c(1,2,1,2,1,2,1,2,1,2,1,2,1,2,1,2, 1,1,1,1,1,1)
