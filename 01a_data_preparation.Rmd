...
cleaned_data_age <- clean_data(data_age, 10, 2400, c(1:4,6,11,13:16,24), method = "linear")
...
all_groups <- list(
  ...
  # Age
  malesWTage    = matrix_age[, 1:6],
  malesHRMage   = matrix_age[, 7:13],
  femalesWTage  = matrix_age[, 14:19]
  #femalesHRMage  = matrix_age[, 26:33],
...
groups_names <- c(
  ...
  "Males WT Aged", "Males HRM Aged", "Females WT Aged"  #Age
  )
